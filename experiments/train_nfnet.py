...
CKPT_DEFAULT = Path('/home/user/work/tf-mp/kaggle/birdclef-2026/bird-clef-2025-all-pretrained-models/models_2025/eca_nfnet_l0_pretrain_from_bigXCV2_best.ckpt')
...
def main():
    ...
    ap.add_argument('--backbone', default='eca_nfnet_l0')
    ap.add_argument('--pretrained', default=str(CKPT_DEFAULT))
    ap.add_argument('--out_dir', default=str(WORK / 'sed_nfnet_e17_out'))
